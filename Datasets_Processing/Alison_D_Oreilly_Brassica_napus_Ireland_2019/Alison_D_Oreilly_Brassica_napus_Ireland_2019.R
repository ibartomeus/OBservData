...
data.site <- read_excel("Alison O'Reilly_Crop_pollination_database .xlsx", sheet = "field_level_data")
...
write_csv(field_level_data, "field_level_data_Alison_D_Oreilly_Brassica_napus_Ireland_2019.csv")
setwd(dir_ini)
