...
field_level_data$Credit <- "Christof Schüepp, Felix Herzog and Martin H. Entling"
...
write.csv(insect_sampling_new, "insect_sampling_Christof_Schüepps_Prunus_avium_Switzerland_2011.csv",row.names = F)
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write.csv(field_level_data, "field_level_data_Christof_Schüepps_Prunus_avium_Switzerland_2011.csv",row.names = F)
setwd(dir_ini)
