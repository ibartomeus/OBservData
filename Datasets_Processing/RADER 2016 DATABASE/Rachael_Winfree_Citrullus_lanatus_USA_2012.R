...
data_raw <- read_csv("Individual CSV/Winfree_griffin_2012.csv")
...
write_csv(insect_sampling, "insect_sampling_Rachael_Winfree_Citrullus_lanatus_USA_2012.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rachael_Winfree_Citrullus_lanatus_USA_2012.csv")
setwd(dir_ini)
