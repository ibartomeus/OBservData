...
data_raw <- read_csv("Individual CSV/Reemer_Kleijn_2011_Apple.csv")
...
write_csv(insect_sampling, "insect_sampling_David_Kleijn_Malus_domestica_Netherlands_2011.csv")
setwd(dir_ini)
...
field_level_data_mod <- read_csv("Individual CSV/field_level_data_David_Kleijn_Malus_domestica_Netherlands_2011.csv")
field_level_data$variety <- field_level_data_mod$variety

setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_David_Kleijn_Malus_domestica_Netherlands_2011.csv")
setwd(dir_ini)
