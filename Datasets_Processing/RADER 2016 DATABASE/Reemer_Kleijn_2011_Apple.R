...
insect_sampling <- tibble(
  study_id = "Reemer_Kleijn_2011_Apple",
...
write_csv(insect_sampling, "insect_sampling_Reemer_Kleijn_2011_Apple.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Reemer_Kleijn_2011_Apple.csv")
setwd(dir_ini)
