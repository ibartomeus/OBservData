...
GPS <- read_excel("Almond_contact_site discription.xls", sheet = "GPS Data") %>%
...
variety <- read_excel("Almond_contact_site discription.xls", sheet = "Final Sites") %>%
...
write_csv(insect_sampling, "insect_sampling_Alexandra_Maria_Klein_Prunus_dulcis_USA_2008.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Alexandra_Maria_Klein_Prunus_dulcis_USA_2008.csv")
setwd(dir_ini)
