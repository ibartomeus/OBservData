...
write_csv(insect_sampling, "insect_sampling_Margaret_Mayfield_Actinidia_deliciosa_New_Zealand_NA.csv")
setwd(dir_ini)
...
field_level_data <- tibble(
  ...
  total_sampled_area = NA,
  total_sampled_time = NA,
  visitation_rate_units = "Visits per 10 minute",
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Margaret_Mayfield_Actinidia_deliciosa_New_Zealand_NA.csv")
setwd(dir_ini)
