...
data_raw <- read_csv("Individual CSV/Hipolito_2005.csv")
...
new_data_raw <- readxl::read_excel("Individual CSV/Mago_data_Juliana_Hipólito_Mangifera_indica_Brazil_2005.xls",skip = 2)
...
# Para a amostragem dos visitantes florais, foram selecionadas duas árvores, 
# considerando a sua localização central no plantio, intensidade e uniformidade da 
# floração na copa. As coletas foram realizadas durante 24 horas em intervalos de 1
# hora com redes entomológicas.
...
write_csv(insect_sampling, "insect_sampling_Juliana_Hipólito_Mangifera_indica_Brazil_2005.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Juliana_Hipólito_Mangifera_indica_Brazil_2005.csv")
setwd(dir_ini)
