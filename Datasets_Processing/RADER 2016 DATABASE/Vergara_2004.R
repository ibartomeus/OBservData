...
data_raw <- read_csv("Individual CSV/Vergara_2004.csv")
...
write_csv(insect_sampling, "insect_sampling_Vergara_2004.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Vergara_2004.csv")
setwd(dir_ini)
