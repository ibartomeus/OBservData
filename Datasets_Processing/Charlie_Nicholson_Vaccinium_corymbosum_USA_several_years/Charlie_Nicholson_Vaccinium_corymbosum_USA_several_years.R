...
write_csv(insect_sampling[,1:10], "insect_sampling_Charlie_Nicholson_Vaccinium_corymbosum_USA_several_years.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Charlie_Nicholson_Vaccinium_corymbosum_USA_several_years.csv")
setwd(dir_ini)
