...
write_csv(insect_sampling, "insect_sampling_saez01.csv")
...
setwd("C:/Users/USUARIO/Desktop/Projects/Observ/Datasets_storage")
write_csv(field_level_data, "field_level_data_saez01.csv")
setwd(dir_ini)
