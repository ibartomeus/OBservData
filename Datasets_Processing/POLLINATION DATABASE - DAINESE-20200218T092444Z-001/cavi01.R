...
data.site <- read.xlsx("DATASETS/Cavi01_Datacollection_pollination.xlsx",
                          sheet = "SiteData", startRow = 2)
data.site <- as_tibble(data.site)

data.site$study_id <- "cavi01"
options(digits=14)
...
data.Functioning <- read.xlsx("DATASETS/Cavi01_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("DATASETS/Cavi01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_cavi01.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_cavi01.csv")
setwd(dir_ini)
