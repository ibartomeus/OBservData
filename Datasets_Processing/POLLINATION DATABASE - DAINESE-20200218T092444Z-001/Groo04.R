...
setwd("C:/Users/USUARIO/OBservData/Observ/Datasets_storage")
write_csv(insect_sampling, "insect_sampling_Groo04.csv")
...
write_csv(field_level_data, "field_level_data_Groo04.csv")
setwd(dir_ini)
