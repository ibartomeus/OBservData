...
tax_res <- read_csv("taxon_table_barn01.csv")
...
write_csv(insect_sampling, "insect_sampling_barn01.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_barn01.csv")
setwd(dir_ini)
