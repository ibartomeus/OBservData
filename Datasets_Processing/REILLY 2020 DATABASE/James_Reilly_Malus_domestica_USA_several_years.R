...
data.site_mi <- read_csv("datasets/apple_mi_dataset.csv")
data.site_pa <- read_csv("datasets/apple_pa_dataset.csv") %>% rename(wild_bee=wild_bees)  
...
write_csv(field_level_data, "field_level_data_James_Reilly_Malus_pumila_USA_2013-14-15.csv")
setwd(dir_ini)
