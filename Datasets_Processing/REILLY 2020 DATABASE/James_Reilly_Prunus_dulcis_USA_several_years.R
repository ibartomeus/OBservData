...
data.site <- read_csv("datasets/almond_ca_dataset_separate_flies_fixed_site_names.csv")
...
write_csv(field_level_data, "field_level_data_James_Reilly_Prunus_dulcis_USA_2013-14.csv")
setwd(dir_ini)
