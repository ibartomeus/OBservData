...
data.site <- read_excel("Crop_pollination_database_ATrillo.xlsx", sheet = "field_level_data")
...
insect_sampling <- read_excel("Crop_pollination_database_ATrillo.xlsx", sheet = "insect_sampling")
...
write_csv(insect_sampling, "insect_sampling_Alejandro_Trillo_Fragaria_ananassa_Spain_2016.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Alejandro_Trillo_Fragaria_ananassa_Spain_2016.csv")
setwd(dir_ini)
