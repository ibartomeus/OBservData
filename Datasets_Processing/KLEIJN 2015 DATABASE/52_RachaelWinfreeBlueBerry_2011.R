...
data.site$study_id <- "52_RachaelWinfreeBlueBerry_2011"
...
insect_sampling <- tibble(
  study_id = "52_RachaelWinfreeBlueBerry_2011",
...
write_csv(insect_sampling, "insect_sampling_52_RachaelWinfreeBlueBerry_2011.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_52_RachaelWinfreeBlueBerry_2011.csv")
setwd(dir_ini)
