...
data.site$study_id <- "48_RachaelWinfreeCranberry_2009"
...
insect_sampling <- tibble(
  study_id = "48_RachaelWinfreeCranberry_2009",
...
write_csv(insect_sampling, "insect_sampling_48_RachaelWinfreeCranberry_2009.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_48_RachaelWinfreeCranberry_2009.csv")
setwd(dir_ini)
