...
write_csv(insect_sampling, "insect_sampling_Ruan_Veldtman_Malus_domestica_South_Africa_2011.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Ruan_Veldtman_Malus_domestica_South_Africa_2011.csv")
setwd(dir_ini)
