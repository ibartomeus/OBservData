...
data.sampling <- 
  ...
  filter(Year==2009) %>% select(Farm,time,area) %>%
...
insect_sampling <- insect_sampling %>% filter(site_id != "Hemlock01")

#sanity check
insect_sampling$site_id %>% unique()

setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(insect_sampling, "insect_sampling_Mia_Park_Malus_domestica_USA_2009.csv")
setwd(dir_ini)
...
field_level_data <- field_level_data %>% filter(site_id != "Hemlock01")

setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Mia_Park_Malus_domestica_USA_2009.csv")
setwd(dir_ini)
