...
data.site$study_id <- "46_RachaelWinfreeTomato_2004"
...
insect_sampling <- tibble(
  study_id = "46_RachaelWinfreeTomato_2004",
...
write_csv(insect_sampling, "insect_sampling_46_RachaelWinfreeTomato_2004.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_46_RachaelWinfreeTomato_2004.csv")
setwd(dir_ini)
