...
write_csv(insect_sampling, "insect_sampling_Sarah_S_Greenleaf_Solanum_lycopersicum_USA_2001.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Sarah_S_Greenleaf_Solanum_lycopersicum_USA_2001.csv")
setwd(dir_ini)
