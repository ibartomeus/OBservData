...
##########################
#Data: Rachael_Winfree_Citrullus_lanatus_USA_2005
##########################

data_raw <- read.xlsx("53_55_RachaelWinfree_Watermelon_2004_05_07/STEP4_winfree_watermelon.xlsx",
                       sheet = "watermelon0405070810")
data_raw <- as_tibble(data_raw)

# Filter data by year

data_raw <- data_raw %>% filter(grepl("2005",data_raw$study_year,ignore.case = TRUE))


# There should be 23 sites
...
data.site$study_id <- "Rachael_Winfree_Citrullus_lanatus_USA_2005"
...
list_organisms_guild$Guild[grep("Agapostemon",
...
list_organisms_guild$Guild[grep("Calliopsis_",
                                list_organisms_guild$Organism_ID,
                                ignore.case = T)] <- "other_wild_bees"
list_organisms_guild$Guild[grep("Hylaeus_",
                                list_organisms_guild$Organism_ID,
                                ignore.case = T)] <- "other_wild_bees"
list_organisms_guild$Guild[grep("Triepeolus_",
                                list_organisms_guild$Organism_ID,
                                ignore.case = T)] <- "other_wild_bees"
...
insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Citrullus_lanatus_USA_2005",
  ...
  Description = "50 meter transect per farm. Two sample days per farm."
)

setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(insect_sampling, "insect_sampling_Rachael_Winfree_Citrullus_lanatus_USA_2005.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rachael_Winfree_Citrullus_lanatus_USA_2005.csv")
setwd(dir_ini)
