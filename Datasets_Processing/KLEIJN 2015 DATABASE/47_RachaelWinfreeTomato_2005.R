...
data.site$study_id <- "47_RachaelWinfreeTomato_2005"
...
insect_sampling <- tibble(
  study_id = "47_RachaelWinfreeTomato_2005",
...
write_csv(insect_sampling, "insect_sampling_47_RachaelWinfreeTomato_2005.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_47_RachaelWinfreeTomato_2005.csv")
setwd(dir_ini)
