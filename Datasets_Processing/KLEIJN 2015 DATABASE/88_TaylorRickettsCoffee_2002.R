...
##########################
#Data: 88_TaylorRickettsCoffee_2002
##########################

data_raw <- read_excel("87_88_TaylorRickettsCoffee_2001_2002/Ricketts_beeabunds_Kleijn.xls",
                       sheet = "Sheet10")
...
data.site$study_id <- "88_TaylorRickettsCoffee_2002"
...
list_organisms_guild$Guild[list_organisms_guild$Organism_ID == "Huge Black 2002"] <- NA
#Sanity Checks
list_organisms_guild %>% filter(is.na(Guild)) %>% group_by(Organism_ID) %>% count()
...
insect_sampling <- tibble(
  study_id = "88_TaylorRickettsCoffee_2002",
...
write_csv(insect_sampling, "insect_sampling_88_TaylorRickettsCoffee_2002.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_88_TaylorRickettsCoffee_2002.csv")
setwd(dir_ini)
