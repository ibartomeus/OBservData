...
data.site$study_id <- "87_TaylorRickettsCoffee_2001"
...
insect_sampling <- tibble(
  study_id = "87_TaylorRickettsCoffee_2001",
...
write_csv(insect_sampling, "insect_sampling_87_TaylorRickettsCoffee_2001.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_87_TaylorRickettsCoffee_2001.csv")
setwd(dir_ini)
