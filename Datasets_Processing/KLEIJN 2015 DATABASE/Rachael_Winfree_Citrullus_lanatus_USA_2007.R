...
##########################
#Data: Rachael_Winfree_Citrullus_lanatus_USA_2007
##########################
...
data_raw <- data_raw %>% filter(grepl("2007",data_raw$study_year,ignore.case = TRUE))
...
data.site$study_id <- "Rachael_Winfree_Citrullus_lanatus_USA_2007"
...
insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Citrullus_lanatus_USA_2007",
...
write_csv(insect_sampling, "insect_sampling_Rachael_Winfree_Citrullus_lanatus_USA_2007.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rachael_Winfree_Citrullus_lanatus_USA_2007.csv")
setwd(dir_ini)
