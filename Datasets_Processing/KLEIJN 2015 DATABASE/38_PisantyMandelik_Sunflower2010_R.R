...
##########################
#Data: 38_PisantyMandelik_Sunflower2010
##########################

data_raw <- read.xlsx("38_PisantyMandelik_Sunflower2010/crop visitors Pisanty and Mandelik_editted.xlsx",
                       sheet = "sunflower")
...
data.site$study_id <- "38_PisantyMandelik_Sunflower2010"
...
insect_sampling <- tibble(
  study_id = "38_PisantyMandelik_Sunflower2010",
...
write_csv(insect_sampling, "insect_sampling_38_PisantyMandelik_Sunflower2010.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_38_PisantyMandelik_Sunflower2010.csv")
setwd(dir_ini)
