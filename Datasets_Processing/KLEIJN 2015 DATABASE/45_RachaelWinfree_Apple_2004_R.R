...
data.site$study_id <- "45_RachaelWinfree_Apple_2004"
...
insect_sampling <- tibble(
  study_id = "45_RachaelWinfree_Apple_2004",
...
write_csv(insect_sampling, "insect_sampling_45_RachaelWinfree_Apple_2004.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_45_RachaelWinfree_Apple_2004.csv")
setwd(dir_ini)
