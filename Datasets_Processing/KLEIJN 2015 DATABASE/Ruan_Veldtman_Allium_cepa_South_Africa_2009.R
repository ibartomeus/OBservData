...
data.site$study_id <- "Ruan_Veldtman_Allium_cepa_South_Africa_2009"
...
insect_sampling <- tibble(
  study_id = "Ruan_Veldtman_Allium_cepa_South_Africa_2009",
...
write_csv(insect_sampling, "insect_sampling_Ruan_Veldtman_Allium_cepa_South_Africa_2009.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Ruan_Veldtman_Allium_cepa_South_Africa_2009.csv")
setwd(dir_ini)
