...
data_raw <- read_excel("74_75_AlexKleinCoffee_2Varieties_2001/Klein_Coffea arabica_flower visitation_raw.xls",
...
data.site <- read_excel("74_75_AlexKleinCoffee_2Varieties_2001/KoordinatenFl.xls",
                        sheet = "Sheet1")
...
data.site$study_id <- "74_AlexKleinCoffee_2Varieties_2001"
...
tax_ID <- read_excel("74_75_AlexKleinCoffee_2Varieties_2001/Klein_Coffea arabica_flower visitation_raw.xls",
                       sheet = "Edits David")
...
insect_sampling <- tibble(
  study_id = "74_AlexKleinCoffee_2Varieties_2001",
...
write_csv(insect_sampling, "insect_sampling_74_AlexKleinCoffee_2Varieties_2001.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_74_AlexKleinCoffee_2Varieties_2001.csv")
setwd(dir_ini)
