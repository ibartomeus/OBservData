...
data.site$study_id <- "44_MiaParkApple_2011"
...
write_csv(insect_sampling, "insect_sampling_44_MiaParkApple_2011.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_44_MiaParkApple_2011.csv")
setwd(dir_ini)
