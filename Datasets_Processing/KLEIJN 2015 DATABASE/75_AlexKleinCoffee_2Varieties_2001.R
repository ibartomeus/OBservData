...
data_raw <- read_excel("74_75_AlexKleinCoffee_2Varieties_2001/Klein_Coffea canephora_flower visitation_raw.xls",
...
data.site$study_id <- "75_AlexKleinCoffee_2Varieties_2001"
...
tax_ID <- read_excel("74_75_AlexKleinCoffee_2Varieties_2001/Klein_Coffea canephora_flower visitation_raw.xls",
                       sheet = "EditsDavid")
...
insect_sampling <- tibble(
  study_id = "75_AlexKleinCoffee_2Varieties_2001",
...
write_csv(insect_sampling, "insect_sampling_75_AlexKleinCoffee_2Varieties_2001.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_75_AlexKleinCoffee_2Varieties_2001.csv")
setwd(dir_ini)
