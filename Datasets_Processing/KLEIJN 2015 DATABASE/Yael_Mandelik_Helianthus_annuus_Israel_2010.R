...
data.site$study_id <- "Yael_Mandelik_Helianthus_annuus_Israel_2010"
...
insect_sampling <- tibble(
  study_id = "Yael_Mandelik_Helianthus_annuus_Israel_2010",
...
write_csv(insect_sampling, "insect_sampling_Yael_Mandelik_Helianthus_annuus_Israel_2010.csv")
setwd(dir_ini)
