...
data.site$study_id <- "58_MacKenzie_AverillExtractedFromPaper"
...
insect_sampling <- tibble(
  study_id = "58_MacKenzie_AverillExtractedFromPaper",
...
write_csv(insect_sampling, "insect_sampling_58_MacKenzie_AverillExtractedFromPaper.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_58_MacKenzie_AverillExtractedFromPaper.csv")
setwd(dir_ini)
