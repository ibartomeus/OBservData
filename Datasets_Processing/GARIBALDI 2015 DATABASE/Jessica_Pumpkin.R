...
data.site$study_id <- "Jessica_Pumpkin"
...
write_csv(insect_sampling, "insect_sampling_Jessica_Pumpkin.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Jessica_Pumpkin.csv")
setwd(dir_ini)
