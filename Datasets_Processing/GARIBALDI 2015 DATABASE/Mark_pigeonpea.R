...
data.site$study_id <- "Mark_pigeonpea"
...
write_csv(insect_sampling, "insect_sampling_Mark_pigeonpea.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Mark_pigeonpea.csv")
setwd(dir_ini)
