...
data.site$study_id <- "Breno_M_Freitas_Gossypium_hirsutum_Brazil_NA"
...
insect_sampling <- tibble(
  study_id = "Breno_M_Freitas_Gossypium_hirsutum_Brazil_NA",
...
write_csv(insect_sampling, "insect_sampling_Breno_M_Freitas_Gossypium_hirsutum_Brazil_NA.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Breno_M_Freitas_Gossypium_hirsutum_Brazil_NA.csv")
setwd(dir_ini)
