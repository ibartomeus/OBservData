...
##########################
#Data: DAINESE, Garr01: garr03 INITIALLY THIS STUDY WAS ASSIGNED TO MICHAEL GARRATT,
# BUT THE CORRESPONDING AUTHOR IS SIMON POTTS
##########################
insect_sampling <- read_csv("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage/insect_sampling_Michael_Garratt_Vicia_faba_UK_2011.csv")
...
write_csv(insect_sampling, "insect_sampling_Michael_Garratt_Vicia_faba_UK_2011.csv")
setwd(dir_ini)


field_level_data <- read_csv("DATASETS/field_level_data_Michael_Garratt_Vicia_faba_UK_2011_MG.csv")
