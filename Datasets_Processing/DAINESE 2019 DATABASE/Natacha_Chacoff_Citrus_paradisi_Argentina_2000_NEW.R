...
flowers.data <- read.xlsx("DATASETS/data chacoff grapefruit 2000.xlsx", sheet = "species")
...
write_csv(insect_sampling, "insect_sampling_Natacha_Chacoff_Citrus_paradisi_Argentina_2000.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Natacha_Chacoff_Citrus_paradisi_Argentina_2000.csv")
setwd(dir_ini)
