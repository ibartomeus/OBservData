...
write_csv(insect_sampling, "insect_sampling_Bryony_Willcox_Mangifera_indica_Australia_2016.csv")
...
field_level_data_rev <- read_csv("DATASETS/Copy of field_level_data_Bryony_Willcox_Mangifera_indica_Australia_2016_BKW.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data_rev, "field_level_data_Bryony_Willcox_Mangifera_indica_Australia_2016.csv")
setwd(dir_ini)
