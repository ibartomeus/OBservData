...
data.site <- read.xlsx("DATASETS/Stew01_Datacollection_pollination.xlsx",
...
data.Final <- read.xlsx("DATASETS/Stew01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Stew01_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("DATASETS/Stew01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Rebecca_Steward_Fragaria_ananassa_Sweden_2014.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rebecca_Steward_Fragaria_ananassa_Sweden_2014.csv")
setwd(dir_ini)
