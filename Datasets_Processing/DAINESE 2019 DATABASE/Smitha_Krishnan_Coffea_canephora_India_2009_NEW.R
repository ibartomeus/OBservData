...
write_csv(insect_sampling, "insect_sampling_Smitha_Krishnan_Coffea_canephora_India_2009.csv")
...
field_level_data <- tibble(
  ...
  total_sampled_time=75*data.site$n, #75min de observación en cada punto de observación de cada granja
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Smitha_Krishnan_Coffea_canephora_India_2009.csv")
setwd(dir_ini)
