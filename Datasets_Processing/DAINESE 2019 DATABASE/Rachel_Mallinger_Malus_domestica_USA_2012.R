...
write_csv(insect_sampling, "insect_sampling_Rachel_Mallinger_Malus_domestica_USA_2012.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rachel_Mallinger_Malus_domestica_USA_2012.csv")
setwd(dir_ini)
