...
write_csv(insect_sampling, "insect_sampling_Georg_Andersson_Fragaria_ananassa_Sweden_2009.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Georg_Andersson_Fragaria_ananassa_Sweden_2009.csv")
setwd(dir_ini)
