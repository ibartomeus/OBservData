...
write_csv(insect_sampling, "insect_sampling_Michael_Garratt_Fragaria_ananassa_UK_2011.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Michael_Garratt_Fragaria_ananassa_UK_2011.csv")
setwd(dir_ini)
