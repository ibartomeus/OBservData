...
##########################
insect_sampling <- read_csv("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage/insect_sampling_Michael_Garratt_Fragaria_ananassa_UK_2011.csv")
...
field_level_data <- read_csv("DATASETS/field_level_data_Michael_Garratt_Fragaria_ananassa_UK_2011_MG.csv")
