...
data.Functioning <- read.xlsx("DATASETS/Hipo01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Juliana_Hipólito_Coffea_arabica_Brazil_2013.csv")
...
field_level_data_mod <- read_csv("DATASETS/field_level_data_Juliana_Hipólito_Coffea_arabica_Brazil_2013.csv")
# Fix errors
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data_mod, "field_level_data_Juliana_Hipólito_Coffea_arabica_Brazil_2013.csv")
setwd(dir_ini)
