...
data.site <- read.xlsx("DATASETS/Pott01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Pott01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Simon_Potts_Vicia_faba_UK_2005.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Simon_Potts_Vicia_faba_UK_2005.csv")
setwd(dir_ini)
