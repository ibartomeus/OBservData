...
data.site <- read.xlsx("DATASETS/Bore02_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Bore02_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("DATASETS/Bore02_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Virginie_Boreux_Malus_domestica_Germany_2015.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Virginie_Boreux_Malus_domestica_Germany_2015.csv")
setwd(dir_ini)
