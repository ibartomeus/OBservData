...
data.site <- read.xlsx("DATASETS/Clas01_Datacollection_pollination_Corrected.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Clas01_Datacollection_pollination_Corrected.xlsx",
...
data.site <- data.site %>% mutate(country="Tanzania",Publication="10.1098/rspb.2013.3148, http://dx.doi.org/10.5281/zenodo.12540",
                                  Credit="Alice Classen, Ingolf Steffan-Dewenter (University of Würzburg). Landscape Data: Thomas Nauss et al. (University of Marburg)",
...
data.species <- read.xlsx("DATASETS/Clas01_Datacollection_pollination_Corrected.xlsx",
...
flowers <- read_csv2("DATASETS/insect_sampling_Alice_Claßen_Coffea_arabica_Tanzania_2011_2012.csv")
...
write_csv(insect_sampling, "insect_sampling_Alice_Classen_Coffea_arabica_Tanzania_2011_2012.csv")
...
add_data <- read_csv2("DATASETS/field_level_data_Alice_Claßen_Coffea_arabica_Tanzania_2011_2012.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Alice_Classen_Coffea_arabica_Tanzania_2011_2012.csv")
setwd(dir_ini)
