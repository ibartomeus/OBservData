...
write_csv(insect_sampling, "insect_sampling_Breno_M_Freitas_Anacardium_occidentale_Brazil_2011.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Breno_M_Freitas_Anacardium_occidentale_Brazil_2011.csv")
setwd(dir_ini)
