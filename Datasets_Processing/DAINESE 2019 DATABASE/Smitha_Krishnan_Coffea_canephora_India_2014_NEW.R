...
data.site <- read.xlsx("DATASETS/Krish02_DataCollection_Pollination.xlsx",
...
sampling <- read.xlsx("DATASETS/flowering_dates_sitewise_2007_2008_2009_2014.xlsx")
...
data.Final <- read.xlsx("DATASETS/Krish02_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Smitha_Krishnan_Coffea_canephora_India_2014.csv")
...
number_sites <- read.xlsx("DATASETS/Krish02_DataCollection_Pollination.xlsx",
                       sheet = "SiteData", startRow = 2)
...
field_level_data <- tibble(
  ...
  total_sampled_time=45*data.site$n, #45 de observación en cada punto de observación de cada granja
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Smitha_Krishnan_Coffea_canephora_India_2014.csv")
setwd(dir_ini)
