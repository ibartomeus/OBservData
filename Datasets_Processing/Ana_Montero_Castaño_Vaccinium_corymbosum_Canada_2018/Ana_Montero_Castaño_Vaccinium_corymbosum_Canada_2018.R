...
data.site <- read.xlsx("Copy of Crop_pollination_database_AnaMontero_v2.xlsx",
...
write_csv(field_level_data, "field_level_data_Ana_Montero_Castaño_Vaccinium_corymbosum_Canada_2018.csv")
setwd(dir_ini)
