...
write_csv(insect_sampling_ob, "insect_sampling_Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2012.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2012.csv")
setwd(dir_ini)
