...
data.site$study_id <- "Malus_domestica_Brazil_2012"
...
insect_sampling_ob <- tibble(
  study_id = "Malus_domestica_Brazil_2012",
...
write_csv(insect_sampling_ob, "insect_sampling_Malus_domestica_Brazil_2012.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Malus_domestica_Brazil_2012.csv")
setwd(dir_ini)
