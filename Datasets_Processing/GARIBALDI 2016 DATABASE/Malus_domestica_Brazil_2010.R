...
data.site$study_id <- "Malus_domestica_Brazil_2010"
...
insect_sampling <- tibble(
  study_id = "Malus_domestica_Brazil_2010",
...
write_csv(insect_sampling_total, "insect_sampling_Malus_domestica_Brazil_2010.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Malus_domestica_Brazil_2010.csv")
setwd(dir_ini)
