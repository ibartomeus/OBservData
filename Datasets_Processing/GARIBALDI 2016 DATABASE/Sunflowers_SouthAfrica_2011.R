...
data.site$study_id <- "Sunflowers_SouthAfrica_2011"
...
insect_sampling <- tibble(
  study_id = "Sunflowers_SouthAfrica_2011",
...
write_csv(insect_sampling_total, "insect_sampling_Sunflowers_SouthAfrica_2011.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Sunflowers_SouthAfrica_2011.csv")
setwd(dir_ini)
