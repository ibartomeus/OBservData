...
# Load data
data_raw <- read.xlsx("Processing_files/Datasets_Processing/GARIBALDI 2016 DATABASE/Colombia/Common database_Vaccinium meridionale Colombia.xlsx",
                       startRow = 3)
...
data.site$study_id <- "Guiomar_Nates_Parra_Vaccinium_meridionale_Colombia_2013"
...
insect_sampling <- tibble(
  study_id = "Guiomar_Nates_Parra_Vaccinium_meridionale_Colombia_2013",
...
write_csv(insect_sampling_total, "Processing_files/Datasets_storage/insect_sampling_Guiomar_Nates_Parra_Vaccinium_meridionale_Colombia_2013.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Guiomar_Nates_Parra_Vaccinium_meridionale_Colombia_2013.csv")
#setwd(dir_ini)
