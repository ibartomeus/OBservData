...
write_csv(insect_sampling_total, "Processing_files/Datasets_storage/insect_sampling_Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2010.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2010.csv")
#setwd(dir_ini)
