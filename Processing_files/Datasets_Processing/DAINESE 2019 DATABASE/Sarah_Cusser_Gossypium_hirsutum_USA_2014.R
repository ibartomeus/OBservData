...
data.site <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Cuss01_Datacollection_pollination.xlsx",
                          sheet = "SiteData", startRow = 2)
data.site <- as_tibble(data.site)

data.site$study_id <- "Sarah_Cusser_Gossypium_hirsutum_USA_2014"
...
data.Functioning <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Cuss01_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Cuss01_Datacollection_pollination.xlsx",
...
data.species <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Cuss01_Datacollection_pollination.xlsx",
...
percentage_species_morphos <-
  sum(data.species_01$Identified.to %in% c("Family- Morphospecies",
                                           "Ladybird sp2",
                                           "Order- Morphospecies",
                                           "Species",
                                           "Subfamily- Morphospecies"))/nrow(data.species_01)
...
insect_sampling <- tibble(
  study_id = "Sarah_Cusser_Gossypium_hirsutum_USA_2014",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Sarah_Cusser_Gossypium_hirsutum_USA_2014.csv")
...
update <- read_csv("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_Sarah_Cusser_Gossypium_hirsutum_USA_2014.csv")


# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(update, "Processing_files/Datasets_storage/field_level_data_Sarah_Cusser_Gossypium_hirsutum_USA_2014.csv")
# setwd(dir_ini)
