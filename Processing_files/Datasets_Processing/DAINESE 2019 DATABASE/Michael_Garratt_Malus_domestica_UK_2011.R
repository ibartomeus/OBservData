...
data.site <- data.site %>% filter(StudyID=="garr02")
options(digits=14)
...
data.Functioning <- data.Functioning %>% filter(StudyID=="garr02") %>% select(-StudyID)
...
yield_aux1 <- yield_aux %>% filter(Function=="% fruit set")
...
yield_aux2 <- yield_aux %>% filter(Function=="seeds per apple")
...
data.species_02$Guild[data.species_02$Organism_ID=="Bombus spp. unknown or unidentified "] <- "bumblebees"
data.species_02$Guild[data.species_02$Organism_ID=="Click beetle"] <- "beetles"
...
insect_sampling <- tibble(
  study_id = "Michael_Garratt_Malus_domestica_UK_2011",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Michael_Garratt_Malus_domestica_UK_2011.csv")
...
abundance_aux <- data.species_02 %>% filter(sampling_method=="transect") %>%
...
abundace_field <- data.species_02 %>% filter(sampling_method=="transect") %>%
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Michael_Garratt_Malus_domestica_UK_2011.csv")
# setwd(dir_ini)

##########################
# UPDATE
##########################
insect_sampling <- read_csv("Processing_files/Datasets_storage/insect_sampling_Michael_Garratt_Malus_domestica_UK_2011.csv")
...
field_level_data <- read_csv("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_Michael_Garratt_Malus_domestica_UK_2011_MG.csv")
