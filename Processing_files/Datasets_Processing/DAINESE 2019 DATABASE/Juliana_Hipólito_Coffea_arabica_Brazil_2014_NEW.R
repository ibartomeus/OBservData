...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Juliana_Hipólito_Coffea_arabica_Brazil_2014.csv")
...
field_level_data_mod <- read_csv("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_Juliana_Hipólito_Coffea_arabica_Brazil_2014.csv")

# Adding latitud and longitude
lat_long_info <- read_csv("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_Juliana_Hipólito_Coffea_arabica_Brazil_2013.csv") %>%
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data_mod, "Processing_files/Datasets_storage/field_level_data_Juliana_Hipólito_Coffea_arabica_Brazil_2014.csv")
# setwd(dir_ini)
