...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Smitha_Krishnan_Coffea_canephora_India_2007.csv")
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Smitha_Krishnan_Coffea_canephora_India_2007.csv")
# setwd(dir_ini)
