...
data.site <- data.site %>% filter(StudyID=="garr01")
...
data.Functioning <- data.Functioning %>% filter(StudyID=="garr01") %>% select(-StudyID)
...
yield_aux$Function <- "Primary fruit weight [g]"
...
data.species_01 <- data.species_01 %>% select(-Identified.to,-X11)
...
insect_sampling <- tibble(
  study_id = "Michael_Garratt_Fragaria_ananassa_UK_2011",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Michael_Garratt_Fragaria_ananassa_UK_2011.csv")
...
abundance_aux <- data.species_01 %>% filter(sampling_method=="transect") %>%
...
abundace_field <- data.species_01 %>% filter(sampling_method=="transect") %>%
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Michael_Garratt_Fragaria_ananassa_UK_2011.csv")
# setwd(dir_ini)
...
# UPDATE
##########################
insect_sampling <- read_csv("Processing_files/Datasets_storage/insect_sampling_Michael_Garratt_Fragaria_ananassa_UK_2011.csv")
...
field_level_data <- read_csv("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_Michael_Garratt_Fragaria_ananassa_UK_2011_MG.csv")
