...
data.site <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Carv01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Carv01_DataCollection_Pollination.xlsx",
...
data.species <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Carv01_Datacollection_pollination.xlsx",
...
insect_sampling <- tibble(
  study_id = "Luísa_G_Carvalheiro_Mangifera_indica_South_Africa_2008",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Luísa_G_Carvalheiro_Mangifera_indica_South_Africa_2008.csv")
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Luísa_G_Carvalheiro_Mangifera_indica_South_Africa_2008.csv")
# setwd(dir_ini)
