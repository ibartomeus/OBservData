...
# We assume that rows/fields from 31 to 45 correspond to Groo02
#data.LandscapeData <- unique(data.LandscapeData)

data.LandscapeData <- data.LandscapeData[31:45,c(1,4)]
...
insect_sampling <- tibble(
  study_id = "David_Kleijn_Vaccinium_corymbosum_Netherlands_2013",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_David_Kleijn_Vaccinium_corymbosum_Netherlands_2013.csv")
...
field_level_data_mod <- read_csv("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_David_Kleijn_Vaccinium_corymbosum_Netherlands_2013.csv")
field_level_data$variety <- field_level_data_mod$variety
field_level_data$yield_units <- field_level_data_mod$yield_units


# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_David_Kleijn_Vaccinium_corymbosum_Netherlands_2013.csv")
# setwd(dir_ini)
