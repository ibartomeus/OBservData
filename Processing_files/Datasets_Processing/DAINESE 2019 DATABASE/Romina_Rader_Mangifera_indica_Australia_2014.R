...
insect_sampling <- tibble(
  study_id = "Romina_Rader_Mangifera_indica_Australia_2014",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Romina_Rader_Mangifera_indica_Australia_2014.csv")
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Romina_Rader_Mangifera_indica_Australia_2014.csv")
# setwd(dir_ini)
