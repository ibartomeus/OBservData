...
options(digits=14)
##########################
#Data: DAINESE, Stew01: stew01
##########################


data.site <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Stew01_Datacollection_pollination.xlsx",
                          sheet = "SiteData", startRow = 2)
data.site <- data.site[,-c(2,3)]

data.site <- as_tibble(data.site)

data.site$study_id <- "Rebecca_Steward_Fragaria_ananassa_Sweden_2014"
...
data.Final <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Stew01_Datacollection_pollination.xlsx",
...
###############################
#pollination index of strawberry

data.Functioning <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Stew01_Datacollection_pollination.xlsx",
                                 sheet = "Functioning", startRow = 2)

data.Functioning <- as_tibble(data.Functioning)

data.Functioning <- data.Functioning %>% select(-Exclosure.treatment) %>%
  rename(site_id=SiteID,sampling_year=Year.of.sampling,yield2= Function,yield2_units= Type.of.function)
...
data.LandscapeData <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Stew01_Datacollection_pollination.xlsx",
...
data.site <- data.site %>% mutate(country="Sweden",Publication="10.1016/j.baae.2016.09.006",
                                  Credit="https://snd.gu.se/en/catalogue/study/by-topic",
                                  email="rebecca.stewart@cec.lu.se")

################################
#COLLECTING INSECT SAMPLING DATA
################################

data.species <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/Stew01_Datacollection_pollination.xlsx",
...
data.species_01 <- data.species_01 %>% mutate(total_sampled_area=600,
                                              ...
                                              Description="Sweep nets along a 200m transect in 1 season. 3 sampling rounds")


insect_sampling <- tibble(
  study_id = "Rebecca_Steward_Fragaria_ananassa_Sweden_2014",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Rebecca_Steward_Fragaria_ananassa_Sweden_2014.csv")
...
# There are "other_wild_bees","syrphids"

# GUILDS:honeybees, bumblebees, other wild bees, syrphids, humbleflies,
# other flies, beetles, non-bee hymenoptera, lepidoptera, and other

abundance_aux <- abundance_aux %>% mutate(beetles=0,bumblebees=0,honeybees=0,
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Rebecca_Steward_Fragaria_ananassa_Sweden_2014.csv")
# setwd(dir_ini)
