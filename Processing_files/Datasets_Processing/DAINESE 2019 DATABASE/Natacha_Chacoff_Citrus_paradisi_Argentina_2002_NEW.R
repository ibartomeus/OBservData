...
flowers.data <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/data chacoff grapefruit 2002.xlsx", sheet = "species")
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Natacha_Chacoff_Citrus_paradisi_Argentina_2002.csv")
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Natacha_Chacoff_Citrus_paradisi_Argentina_2002.csv")
# setwd(dir_ini)
