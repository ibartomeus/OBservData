...
#data.species_03$Guild[data.species_03$Organism_ID=="Carpophilus sp. "] <- "beetles"
...
data.species_03 <- data.species_03 %>% mutate(total_sampled_area=Number.of.censuses*150,
                                              ...
                                              Description="30 plant per site,	150 m, 4 sampling rounds (censuses) in one season ")


insect_sampling <- tibble(
  study_id = "Breno_M_Freitas_Bixa_orellana_Brazil_2007",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Breno_M_Freitas_Bixa_orellana_Brazil_2007.csv")
...
# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Breno_M_Freitas_Bixa_orellana_Brazil_2007.csv")
# setwd(dir_ini)
...
data.site <- read.xlsx("Processing_files/Datasets_processing/DAINESE 2019 DATABASE/DATASETS/field_level_data_Breno_M_Freitas_Bixa_orellana_Brazil_2007_correct.xlsx",
                       sheet = "field_level_data_Breno_M_Freita", startRow = 1)
data.site <- as_tibble(data.site)

# setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(data.site, "Processing_files/Datasets_storage/field_level_data_Breno_M_Freitas_Bixa_orellana_Brazil_2007.csv")
# setwd(dir_ini)
