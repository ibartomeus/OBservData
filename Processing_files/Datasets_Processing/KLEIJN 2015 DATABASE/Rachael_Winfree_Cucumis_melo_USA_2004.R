...
##########################
#Data: 50_RachaelWinfreeMuskMelon_2004
##########################

data_raw <- read.xlsx("Processing_files/Datasets_processing/KLEIJN 2015 DATABASE/50_RachaelWinfreeMuskMelon_2004/STEP4_winfree_muskmelon.xlsx",
                       sheet = "winfree_muskmelon")
data_raw <- as_tibble(data_raw)

# Tranforms date to proper units

data_raw$date <- openxlsx::convertToDate(data_raw$fdate,origin = "1904-01-01")
data_raw$month_of_study <- as.numeric(format(as.Date(data_raw$date, format="%Y/%m/%d"),"%m"))


# There should be 14 sites
data_raw %>% group_by(farmcode) %>% count()
# There are only 13 farmcodes.
...
data.site$study_id <- "Rachael_Winfree_Cucumis_melo_USA_2004"
data.site$crop <- "Cucumis melo"
...
list_organisms_guild$Guild[list_organisms_guild$Organism_ID=="Bombus_fervidus"] <- "bumblebees"
...
insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Cucumis_melo_USA_2004",
  ...
  Description = "One 50 meter transect was used per farm"
)

#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Rachael_Winfree_Cucumis_melo_USA_2004.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Rachael_Winfree_Cucumis_melo_USA_2004.csv")
#setwd(dir_ini)
