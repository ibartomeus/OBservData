...
data_raw <- read.xlsx("Processing_files/Datasets_processing/KLEIJN 2015 DATABASE/38_PisantyMandelik_Sunflower2010/crop visitors Pisanty and Mandelik_editted.xlsx",
                       sheet = "sunflower")
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Yael_Mandelik_Helianthus_annuus_Israel_2010.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Yael_Mandelik_Helianthus_annuus_Israel_2010.csv")
#setwd(dir_ini)
