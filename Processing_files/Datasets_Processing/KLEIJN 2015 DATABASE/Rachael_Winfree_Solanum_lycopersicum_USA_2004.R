...
##########################
#Data: 46_RachaelWinfreeTomato_2004
##########################
...
data_raw <- data_raw %>% filter(grepl("2004",data_raw$study,ignore.case = TRUE))
...
data.site$study_id <- "Rachael_Winfree_Solanum_lycopersicum_USA_2004"
...
insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Solanum_lycopersicum_USA_2004",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Rachael_Winfree_Solanum_lycopersicum_USA_2004.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Rachael_Winfree_Solanum_lycopersicum_USA_2004.csv")
#setwd(dir_ini)
