...
##########################
#Data: 74_AlexKleinCoffee_2Varieties_2001
##########################

data_raw <- read_excel("Processing_files/Datasets_processing/KLEIJN 2015 DATABASE/74_75_AlexKleinCoffee_2Varieties_2001/Klein_Coffea arabica_flower visitation_raw.xls",
                       sheet = "Su mit Eeinzeltieren")

data_raw <- as_tibble(data_raw)

# Remove extra rows

data_raw <- data_raw[1:72,1:32]
...
data.site$study_id <- "Alexandra_Maria_Klein_Coffea_arabica_Indonesia_2000_2001"
...
data.site$Publication <- "10.1098/rspb.2002.2306"
...
data_raw_obs <- data_raw %>% select(-trees,-`Forest distance`) %>% rename(site_id=Site)
...
tax_ID <- read_excel("Processing_files/Datasets_processing/KLEIJN 2015 DATABASE/74_75_AlexKleinCoffee_2Varieties_2001/Klein_Coffea arabica_flower visitation_raw.xls",
                       sheet = "Edits David")

tax_ID <- tax_ID[1:29,c(1,5)] %>% as_tibble()
...
#"Apis nigrocinta binghami" <- "other_wild_bees" (as in the case of Apis Cerana)
...
insect_sampling <- tibble(
  study_id = "Alexandra_Maria_Klein_Coffea_arabica_Indonesia_2000_2001",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Alexandra_Maria_Klein_Coffea_arabica_Indonesia_2000_2001.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Alexandra_Maria_Klein_Coffea_arabica_Indonesia_2000_2001.csv")
#setwd(dir_ini)
