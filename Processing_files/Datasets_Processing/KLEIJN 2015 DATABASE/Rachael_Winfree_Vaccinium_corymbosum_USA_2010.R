...
##########################
#Data: 51_RachaelWinfreeBlueBerry_2010
##########################

data_raw <- read.xlsx("Processing_files/Datasets_processing/KLEIJN 2015 DATABASE/51_52_RachaelWinfreeBlueBerry_2010_2011/STEP4_winfree_blueberry.xlsx",
                       sheet = "blueberry1011")
...
data.site$study_id <- "Rachael_Winfree_Vaccinium_corymbosum_USA_2010"
...
# Number of sampling days per site

sampling_days <- data_raw %>%
  select(farmcode,date) %>% unique() %>% group_by(farmcode) %>% count()

insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Vaccinium_corymbosum_USA_2010",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Rachael_Winfree_Vaccinium_corymbosum_USA_2010.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Rachael_Winfree_Vaccinium_corymbosum_USA_2010.csv")
#setwd(dir_ini)
