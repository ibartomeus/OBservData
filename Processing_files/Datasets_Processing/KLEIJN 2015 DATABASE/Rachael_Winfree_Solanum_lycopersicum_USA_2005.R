...
##########################
#Data: 47_RachaelWinfreeTomato_2005
##########################

data_raw <- read.xlsx("Processing_files/Datasets_processing/KLEIJN 2015 DATABASE/46_47_RachaelWinfreeTomato_2004_2005/STEP4_winfree_tomato.xlsx",
                       sheet = "tomato0405")
...
# Filter data by year
data_raw <- data_raw %>% filter(grepl("2005",data_raw$study,ignore.case = TRUE))
...
data.site$study_id <- "Rachael_Winfree_Solanum_lycopersicum_USA_2005"
...
insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Solanum_lycopersicum_USA_2005",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Rachael_Winfree_Solanum_lycopersicum_USA_2005.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Rachael_Winfree_Solanum_lycopersicum_USA_2005.csv")
#setwd(dir_ini)
