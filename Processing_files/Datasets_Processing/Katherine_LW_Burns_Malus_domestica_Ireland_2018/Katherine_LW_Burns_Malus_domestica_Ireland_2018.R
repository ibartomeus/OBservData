...
data.site <- read.xlsx("Processing_files/Datasets_Processing/Katherine_LW_Burns_Malus_domestica_Ireland_2018/globalcrop.APPLE.BurnsStanley_REVISED.xlsx",
...
data.insect <- read.xlsx("Processing_files/Datasets_Processing/Katherine_LW_Burns_Malus_domestica_Ireland_2018/globalcrop.APPLE.BurnsStanley_REVISED.xlsx",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Katherine_LW_Burns_Malus_domestica_Ireland_2018.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Katherine_LW_Burns_Malus_domestica_Ireland_2018.csv")
#setwd(dir_ini)
