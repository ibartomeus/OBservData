...
data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Rundlof_2011.csv")
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Maj_Rundlof_Brassica_napus_Sweden_2011.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Maj_Rundlof_Brassica_napus_Sweden_2011.csv")
#setwd(dir_ini)
