...
data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Cunningham_2001.csv")
...
data.site_aux <- tibble(
  study_id = "Saul_A_Cunningham_Annona_squamosa atemoya_Australia_2001",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Saul_A_Cunningham_Annona_squamosa atemoya_Australia_2001.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Saul_A_Cunningham_Annona_squamosa atemoya_Australia_2001.csv")
#setwd(dir_ini)
