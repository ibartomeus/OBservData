...
data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Cunningham_2006.csv")
...
data.site_aux <- tibble(
  study_id = "Saul_A_Cunningham_Brassica_napus_Australia_2006",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Saul_A_Cunningham_Brassica_napus_Australia_2006.csv")
#setwd(dir_ini)
...
field_level_data <- tibble(
  ...
  richness_restriction = "bees and syrphids",
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Saul_A_Cunningham_Brassica_napus_Australia_2006.csv")
#setwd(dir_ini)
