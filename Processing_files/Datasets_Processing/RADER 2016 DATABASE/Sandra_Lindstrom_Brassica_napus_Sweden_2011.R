...
data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Lindstrom_2011.csv")
...
data.site_aux <- tibble(
  study_id = "Sandra_Lindstrom_Brassica_napus_Sweden_2011",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Sandra_Lindstrom_Brassica_napus_Sweden_2011.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2011.csv")
#setwd(dir_ini)

#UPDATE

data_raw <- read.delim("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2011.csv",
                       header = T,sep = ";")
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(data_raw, "Processing_files/Datasets_storage/field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2011.csv")
#setwd(dir_ini)
