...
##########################
#Data: Winfree_griffin_2012
##########################

data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Winfree_griffin_2012.csv")
...
data.site_aux <- tibble(
  study_id = "Rachael_Winfree_Citrullus_lanatus_USA_2012",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Rachael_Winfree_Citrullus_lanatus_USA_2012.csv")
#setwd(dir_ini)
...
visit_aux <- visit_aux %>% mutate(beetles=0,other_flies=0,
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Rachael_Winfree_Citrullus_lanatus_USA_2012.csv")
#setwd(dir_ini)
