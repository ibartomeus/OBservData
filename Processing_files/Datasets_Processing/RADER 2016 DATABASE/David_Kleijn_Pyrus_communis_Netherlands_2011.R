...
##########################
#Data: Reemer_Kleijn_2011
##########################

data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Reemer_Kleijn_2011.csv")
...
data.site_aux <- tibble(
  study_id = "David_Kleijn_Pyrus_communis_Netherlands_2011",
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_David_Kleijn_Pyrus_communis_Netherlands_2011.csv")
#setwd(dir_ini)
...
field_level_data_mod <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/field_level_data_David_Kleijn_Pyrus_communis_Netherlands_2011.csv")
field_level_data$variety <- field_level_data_mod$variety

#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_David_Kleijn_Pyrus_communis_Netherlands_2011.csv")
#setwd(dir_ini)
