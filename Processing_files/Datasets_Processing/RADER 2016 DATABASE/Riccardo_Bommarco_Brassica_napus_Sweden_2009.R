...
##########################
#Data: Bommarco_Rundlof_2009
##########################

data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Bommarco_Rundlof_2009.csv")
...
data.site_aux <- tibble(
  study_id = "Riccardo_Bommarco_Brassica_napus_Sweden_2009",
  site_id = data_raw_without_NAs$site,
  crop = "Brassica napus",
  variety = NA,
  management = data_raw_without_NAs$land_management,
  country = "Sweden",
  latitude = NA,#"58?21'41''N",
  longitude = NA,#"13?9'59''E",
  X_UTM=NA,
  Y_UTM=NA,
  zone_UTM=NA,
...
data.site$Credit  <- "Riccardo Bommarco"
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Riccardo_Bommarco_Brassica_napus_Sweden_2009.csv")
#setwd(dir_ini)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Riccardo_Bommarco_Brassica_napus_Sweden_2009.csv")
#setwd(dir_ini)
