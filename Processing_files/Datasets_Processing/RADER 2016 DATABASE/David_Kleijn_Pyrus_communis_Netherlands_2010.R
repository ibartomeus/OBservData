...
##########################
#Data: Reemer_Kleijn_2010
##########################

data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Reemer_Kleijn_2010.csv")
...
data.site_aux <- tibble(
  study_id = "David_Kleijn_Pyrus_communis_Netherlands_2010",
  site_id = paste0(data_raw_without_NAs$site,"_",data_raw_without_NAs$sample_num),
  crop = "Pyrus communis",
  variety = NA,
...
data_raw_obs <- mutate(data_raw_obs,
                       site=paste0(data_raw_obs$site,"_",data_raw_obs$sample_num))
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_David_Kleijn_Pyrus_communis_Netherlands_2010.csv")
#setwd(dir_ini)
...
field_level_data_mod <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/field_level_data_David_Kleijn_Pyrus_communis_Netherlands_2010.csv")
field_level_data$variety <- field_level_data_mod$variety

#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_David_Kleijn_Pyrus_communis_Netherlands_2010.csv")
#setwd(dir_ini)
