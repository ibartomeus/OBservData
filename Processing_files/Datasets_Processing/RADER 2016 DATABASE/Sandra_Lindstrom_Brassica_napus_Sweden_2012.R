...
data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Lindstrom_2012.csv")
...
data.site_aux <- tibble(
  study_id = "Sandra_Lindstrom_Brassica_napus_Sweden_2012",
...
# Gather observations
data_raw_gather <- data_raw_obs %>% gather(-sample_num,key = "Organism_ID", value = 'Abundance', !contains("sample_num"))
...
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Sandra_Lindstrom_Brassica_napus_Sweden_2012.csv")
#setwd(dir_ini)
...
data_raw_gather <-  data_raw_gather %>%
  group_by(sample_num,Organism_ID,Family,Guild) %>% summarise_all(sum,na.rm=TRUE)
...
# "lepidoptera"      "non_bee_hymenoptera"              "other_flies"

# GUILDS:honeybees, bumblebees, other wild bees, syrphids, humbleflies,
# other flies, beetles, non-bee hymenoptera, lepidoptera, and other

abundance_aux <- abundance_aux %>% mutate(beetles=0,humbleflies=0,other=0,total=0)
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2012.csv")
#setwd(dir_ini)

##########################
#UPDATE: Lindstrom_2012
##########################

data_raw <- read.delim("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2012.csv",
                       header = T,sep = ";")
...
#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(data_raw, "Processing_files/Datasets_storage/field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2012.csv")
#setwd(dir_ini)
