...
data_raw <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/Scheper_2012.csv")
...
data.site_aux <- tibble(
  study_id = "Jeroen_Scheper_Brassica_napus_several_countries_2012",
...
insect_sampling <- tibble(
  ...
  Description = "Two rounds per field. Each sampling round consists in two 150 x 1 m transect (15 min each)"
)

#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(insect_sampling, "Processing_files/Datasets_storage/insect_sampling_Jeroen_Scheper_Brassica_napus_several_countries_2012.csv")
#setwd(dir_ini)
...
field_level_data_mod <- read_csv("Processing_files/Datasets_Processing/RADER 2016 DATABASE/Individual CSV/field_level_data_Jeroen_Scheper_Brassica_napus_several_countries_2012.csv")
field_level_data$field_size <- field_level_data_mod$field_size

#setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Jeroen_Scheper_Brassica_napus_several_countries_2012.csv")
#setwd(dir_ini)
