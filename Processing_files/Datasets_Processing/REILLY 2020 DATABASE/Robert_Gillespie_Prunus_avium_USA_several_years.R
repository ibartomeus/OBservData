...
data.site <- read_csv("Processing_files/Datasets_processing/REILLY 2020 DATABASE/datasets/sweet_cherry_wa_dataset_separate_flies.csv")
...
# New study_id
data.site$study_id <- paste0("Robert_Gillespie_Prunus_avium_USA_",data.site$year)


# Crop latin name
data.site$crop <- "Prunus avium"
...
field_level_data <- tibble(
  ...
  Credit = "Robert W. Gillespie and all the co-authors in the referred publication",
  Email_contact = "bgillespie@wvc.edu/jreilly45@gmail.com/rwinfree@rutgers.edu/isaacsr@msu.edu"
)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Robert_Gillespie_Prunus_avium_USA_2013-14.csv")
#setwd(dir_ini)
