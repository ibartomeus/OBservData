...
data.site <- data.site_mi_bc_or %>% filter(state=="or") #bind_rows(data.site_fl,data.site_mi_bc_or)
...
# New study_id
data.site$study_id <- paste0("Sujaya_Rao_Vaccinium_corymbosum_USA_",data.site$year)
...
field_level_data <- tibble(
  ...
  Credit = "Sujaya Rao and all the co-authors in the referred publication",
  Email_contact = "sujaya@umn.edu/jreilly45@gmail.com/rwinfree@rutgers.edu/isaacsr@msu.edu"
)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Sujaya_Rao_Vaccinium_corymbosum_USA_2013-14-15.csv")
#setwd(dir_ini)
