...
# New study_id
data.site$study_id <- paste0("Nikki_Rothwell_Prunus_cerasus_USA_",data.site$year)
...
field_level_data <- tibble(
  ...
  Credit = "Nikki Rothwell and all the co-authors in the referred publication",
  Email_contact = "rothwel3@msu.edu/jreilly45@gmail.com/rwinfree@rutgers.edu/isaacsr@msu.edu"
)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Nikki_Rothwell_Prunus_cerasus_USA_2013-14-15.csv")
#setwd(dir_ini)
