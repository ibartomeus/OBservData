...
# New study_id
data.site$study_id <- paste0("James_Reilly_Malus_pumila_USA_",data.site$year)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_James_Reilly_Malus_pumila_USA_2013-14-15.csv")
#setwd(dir_ini)
