...
data.site <- data.site_fl # bind_rows(data.site_ca,data.site_fl)
...
# New study_id
data.site$study_id <- paste0("Jamie_Ellis_Citrullus_lanatus_USA_",data.site$year)
...
field_level_data <- tibble(
  ...
  Credit = "Jamie Ellis and all the co-authors in the referred publication",
  Email_contact = "jdellis@ufl.edu/jreilly45@gmail.com/rwinfree@rutgers.edu/isaacsr@msu.edu"
)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Jamie_Ellis_Citrullus_lanatus_USA_2013-14-15.csv")
#setwd(dir_ini)
