...
data.site_mi <- read_csv("Processing_files/Datasets_processing/REILLY 2020 DATABASE/datasets/apple_mi_dataset.csv")
#data.site_pa <- read_csv("Processing_files/Datasets_processing/REILLY 2020 DATABASE/datasets/apple_pa_dataset.csv") %>% rename(wild_bee=wild_bees)

data.site <- data.site_mi # bind_rows(data.site_mi,data.site_pa)
...
# New study_id
data.site$study_id <- paste0("Julianna_Wilson_Malus_domestica_USA_",data.site$year)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Julianna_Wilson_Malus_pumila_USA_2013-14-15.csv")
#setwd(dir_ini)
