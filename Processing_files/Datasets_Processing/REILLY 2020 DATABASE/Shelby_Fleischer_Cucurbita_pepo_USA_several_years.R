...
data.site <- read_csv("Processing_files/Datasets_processing/REILLY 2020 DATABASE/datasets/pumpkin_pa_dataset.csv")
...
# New study_id
data.site$study_id <- paste0("Shelby_Fleischer_Cucurbita_pepo_USA_",data.site$year)
...
field_level_data <- tibble(
  ...
  Credit = "Shelby Fleischer and all the co-authors in the referred publication",
  Email_contact = "sjf4@psu.edu/jreilly45@gmail.com/rwinfree@rutgers.edu/isaacsr@msu.edu"
)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Shelby_Fleischer_Cucurbita_pepo_USA_2013-14-15.csv")
#setwd(dir_ini)
