...
# New study_id
data.site$study_id <- paste0("Theresa_PittsSinger_Prunus_dulcis_USA_",data.site$year)
...
field_level_data <- tibble(
  ...
  Credit = "Theresa Pitts-Singer and all the co-authors in the referred publication",
  Email_contact = "Theresa.Pitts-Singer@ars.usda.gov/jreilly45@gmail.com/rwinfree@rutgers.edu/isaacsr@msu.edu"
)
...
write_csv(field_level_data, "Processing_files/Datasets_storage/field_level_data_Theresa_PittsSinger_Prunus_dulcis_USA_2013-14.csv")
#setwd(dir_ini)
