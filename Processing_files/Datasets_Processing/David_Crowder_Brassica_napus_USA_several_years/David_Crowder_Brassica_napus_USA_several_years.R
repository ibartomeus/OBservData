...
data.site <- read.xlsx("Processing_files/Datasets_Processing/David_Crowder_Brassica_napus_USA_several_years/Crop_pollination_database_Lichtenberg-Crowder.xlsx",
...
# Latin name of canola/ country

data.site$crop <- "Brassica napus"
data.site$country <- "USA"

# Sanity check names
data.site %>% group_by(site_id,sampling_year) %>% count() %>% filter(n>1) #All site_id (per year) are unique
...
data.insect <- read.xlsx("Processing_files/Datasets_Processing/David_Crowder_Brassica_napus_USA_several_years/Crop_pollination_database_Lichtenberg-Crowder.xlsx",
...
names(data.insect)[names(data.insect)=="Description.(Fee.text)"] <- "Description"
...
write_csv(insect_sampling_2013, "Processing_files/Datasets_storage/insect_sampling_David_Crowder_Brassica_napus_USA_2013.csv")
write_csv(insect_sampling_2014, "Processing_files/Datasets_storage/insect_sampling_David_Crowder_Brassica_napus_USA_2014.csv")
#setwd(dir_ini)
...
field_level_data_2013$study_id <- "Processing_files/Datasets_storage/David_Crowder_Brassica_napus_USA_2013"

field_level_data_2014 <- field_level_data %>% filter(site_id %in% sites_2014)
field_level_data_2014$study_id <- "Processing_files/Datasets_storage/David_Crowder_Brassica_napus_USA_2014"
