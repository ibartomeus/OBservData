...
write_csv(insect_sampling, "insect_sampling_Alexandra_Maria_Klein_Coffea_canephora_Indonesia_2000_2001.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Alexandra_Maria_Klein_Coffea_canephora_Indonesia_2000_2001.csv")
setwd(dir_ini)
