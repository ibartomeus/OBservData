...
write_csv(insect_sampling_total, "insect_sampling_Guiomar_Nates_Parra_Vaccinium_meridionale_Colombia_2013.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Guiomar_Nates_Parra_Vaccinium_meridionale_Colombia_2013.csv")
setwd(dir_ini)
