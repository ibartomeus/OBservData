...
write_csv(insect_sampling, "insect_sampling_Blande_Viana_Passiflora_edulis_Brazil_2005.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Blande_Viana_Passiflora_edulis_Brazil_2005.csv")
setwd(dir_ini)
