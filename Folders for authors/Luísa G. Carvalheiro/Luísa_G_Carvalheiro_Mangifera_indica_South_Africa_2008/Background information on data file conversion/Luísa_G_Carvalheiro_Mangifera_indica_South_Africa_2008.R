...
write_csv(insect_sampling, "insect_sampling_Luísa_G_Carvalheiro_Mangifera_indica_South_Africa_2008.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Luísa_G_Carvalheiro_Mangifera_indica_South_Africa_2008.csv")
setwd(dir_ini)
