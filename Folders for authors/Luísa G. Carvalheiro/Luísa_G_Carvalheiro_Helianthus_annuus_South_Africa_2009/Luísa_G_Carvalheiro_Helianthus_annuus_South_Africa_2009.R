...
insect_sampling <- tibble(
  study_id = "Luísa_G_Carvalheiro_Helianthus_annuus_South_Africa_2009",
...
write_csv(insect_sampling, "insect_sampling_Luísa_G_Carvalheiro_Helianthus_annuus_South_Africa_2009.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Luísa_G_Carvalheiro_Helianthus_annuus_South_Africa_2009.csv")
setwd(dir_ini)
