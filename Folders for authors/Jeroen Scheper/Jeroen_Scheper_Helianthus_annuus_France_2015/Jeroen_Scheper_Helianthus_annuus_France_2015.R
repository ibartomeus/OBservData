...
data.site <- read.xlsx("DATASETS/Sche01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Sche01_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("DATASETS/Sche01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Jeroen_Scheper_Helianthus_annuus_France_2015.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Jeroen_Scheper_Helianthus_annuus_France_2015.csv")
setwd(dir_ini)
