...
write_csv(insect_sampling, "insect_sampling_Virginie_Boreux_Coffea_canephora_India_2008.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Virginie_Boreux_Coffea_canephora_India_2008.csv")
setwd(dir_ini)
