...
data_raw <- read_excel("20_DavidKleijn_alliumporrum2012/Italie_David_2012_def.xls",
                       sheet = "Bijen_totaal")
...
write_csv(insect_sampling, "insect_sampling_David_Kleijn_Allium_porrum_Italy_2012.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_David_Kleijn_Allium_porrum_Italy_2012.csv")
setwd(dir_ini)
