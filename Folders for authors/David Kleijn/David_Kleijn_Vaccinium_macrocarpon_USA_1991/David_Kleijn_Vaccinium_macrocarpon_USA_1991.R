...
write_csv(insect_sampling, "insect_sampling_David_Kleijn_Vaccinium_macrocarpon_USA_1991.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_David_Kleijn_Vaccinium_macrocarpon_USA_1991.csv")
setwd(dir_ini)
