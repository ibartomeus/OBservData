...
write_csv(insect_sampling, "insect_sampling_Saul_A_Cunningham_Brassica_napus_Australia_2006.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Saul_A_Cunningham_Brassica_napus_Australia_2006.csv")
setwd(dir_ini)
