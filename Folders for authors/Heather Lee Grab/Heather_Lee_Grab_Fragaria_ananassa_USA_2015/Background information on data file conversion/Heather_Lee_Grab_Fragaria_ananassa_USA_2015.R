...
options(digits=14)
##########################
#Data: DAINESE, Grab01: conn02 2015
##########################
...
data.Final <- data.Final %>% filter(StudyID=="conn02",Year.of.sampling==2015) %>% select(-StudyID)
...
data.Final$X7[data.Final$X7=="hand "] <- "hand"
data.Final$X7[data.Final$X7=="open "] <- "open"
...
data.Functioning <- data.Functioning %>% filter(StudyID=="conn02",Year.of.sampling==2015) %>% select(-StudyID)
...
data.species_01 <- data.species %>% filter(study_id=="conn02",sampling_year==2015)
...
data.species_01$Guild[data.species_01$Organism_ID=="Hoplitis sp "] <- "other_wild_bees"
data.species_01$Guild[data.species_01$Organism_ID=="Large Andrena ap. "] <- "other_wild_bees"
data.species_01$Guild[data.species_01$Organism_ID=="Large Andrena sp. "] <- "other_wild_bees"
data.species_01$Guild[data.species_01$Organism_ID=="Small Andrena sp. "] <- "other_wild_bees"
data.species_01$Guild[data.species_01$Organism_ID=="Specodes sp. "] <- "other_wild_bees"
...
insect_sampling <- tibble(
  study_id = "Heather_Lee_Grab_Fragaria_ananassa_USA_2015",
...
write_csv(insect_sampling, "insect_sampling_Heather_Lee_Grab_Fragaria_ananassa_USA_2015.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Heather_Lee_Grab_Fragaria_ananassa_USA_2015.csv")
setwd(dir_ini)
