...
data.site <- read.xlsx("DATASETS/Taki01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Taki01_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("DATASETS/Taki01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Hisatomo_Taki_Fagopyrum_esculentum_Japan_2008.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Hisatomo_Taki_Fagopyrum_esculentum_Japan_2008.csv")
setwd(dir_ini)
