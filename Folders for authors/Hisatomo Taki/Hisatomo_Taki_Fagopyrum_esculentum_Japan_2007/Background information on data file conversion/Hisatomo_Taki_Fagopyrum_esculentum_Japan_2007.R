...
write_csv(insect_sampling, "insect_sampling_Hisatomo_Taki_Fagopyrum_esculentum_Japan_2007.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Hisatomo_Taki_Fagopyrum_esculentum_Japan_2007.csv")
setwd(dir_ini)
