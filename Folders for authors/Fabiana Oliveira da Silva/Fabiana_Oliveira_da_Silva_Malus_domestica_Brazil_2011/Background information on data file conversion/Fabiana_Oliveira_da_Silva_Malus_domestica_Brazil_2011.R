...
data_raw <- data_raw[grepl("2011",data_raw$Site_name,ignore.case = TRUE),]
...
data.site$study_id <- "Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2011"
...
insect_sampling_ob <- tibble(
  study_id = "Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2011",
...
write_csv(insect_sampling_ob, "insect_sampling_Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2011.csv")
setwd(dir_ini)
...
abundance_aux <- abundance_aux %>% mutate(beetles=0,bumblebees=0,other_flies=0,
                                          ...
                                          syrphids=0,humbleflies=0,other_wild_bees=0,
                                          total=0)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Fabiana_Oliveira_da_Silva_Malus_domestica_Brazil_2011.csv")
setwd(dir_ini)
