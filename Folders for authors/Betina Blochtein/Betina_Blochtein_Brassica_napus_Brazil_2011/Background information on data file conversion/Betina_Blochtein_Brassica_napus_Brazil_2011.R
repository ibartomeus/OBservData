...
data.site$study_id <- "Betina_Blochtein_Brassica_napus_Brazil_2011"
...
insect_sampling <- tibble(
  study_id = "Betina_Blochtein_Brassica_napus_Brazil_2011",
...
write_csv(insect_sampling, "insect_sampling_Betina_Blochtein_Brassica_napus_Brazil_2011.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Betina_Blochtein_Brassica_napus_Brazil_2011.csv")
setwd(dir_ini)
