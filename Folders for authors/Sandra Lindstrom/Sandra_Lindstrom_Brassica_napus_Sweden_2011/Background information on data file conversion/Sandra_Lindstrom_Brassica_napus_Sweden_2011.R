...
write_csv(insect_sampling, "insect_sampling_Sandra_Lindstrom_Brassica_napus_Sweden_2011.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Sandra_Lindstrom_Brassica_napus_Sweden_2011.csv")
setwd(dir_ini)
