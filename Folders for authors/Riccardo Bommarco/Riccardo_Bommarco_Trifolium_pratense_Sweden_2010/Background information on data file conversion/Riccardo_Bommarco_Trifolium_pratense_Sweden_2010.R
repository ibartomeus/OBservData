...
##########################
#Data: 4_5_RiccardoBommarco_RedClover_2010
##########################
...
data_raw <- data_raw %>% filter(Year==2010)
...
data.site$study_id <- "Riccardo_Bommarco_Trifolium_pratense_Sweden_2010"
...
insect_sampling <- tibble(
  study_id = "Riccardo_Bommarco_Trifolium_pratense_Sweden_2010",
  ...
  total_sampled_area = 4*50*data_obs_guild$'N sites', # In 2010, each site was visited between three to five times (mean 4 visits per site)
  total_sampled_time = NA,
  total_sampled_flowers = NA,
  Description = "Bumble-bees were collected along 1 m wide and 50 m long transects in 14 sites. Each site was visited three to five times (mean 4  visits per site)."
)

setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(insect_sampling, "insect_sampling_Riccardo_Bommarco_Trifolium_pratense_Sweden_2010.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Riccardo_Bommarco_Trifolium_pratense_Sweden_2010.csv")
setwd(dir_ini)
