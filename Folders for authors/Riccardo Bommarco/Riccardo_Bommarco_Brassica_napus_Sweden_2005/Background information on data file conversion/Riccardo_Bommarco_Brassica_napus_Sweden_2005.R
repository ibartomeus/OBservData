...
data.site <- read.xlsx("DATASETS/Bomm01_Datacollection_pollination.xlsx",
...
data.Final <- read.xlsx("DATASETS/Bomm01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Riccardo_Bommarco_Brassica_napus_Sweden_2005.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Riccardo_Bommarco_Brassica_napus_Sweden_2005.csv")
setwd(dir_ini)
