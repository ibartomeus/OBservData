...
##########################
#Data: 2_3_RiccardoBommarco_RedClover_2009
##########################

data_raw <- read_excel("1_5_RiccardoBommarco_RedClover/Clover_studydata_STEP_WP4.xls",
                       sheet = "DATAWP4STUDY")
...
data_raw <- data_raw %>% filter(Year==2009)

# Fix species names

tax_ID <- read_excel("1_5_RiccardoBommarco_RedClover/Clover_studydata_STEP_WP4.xls",
                       sheet = "species")
...
region_list <- c("M" = "Östergötland","E"="Skåne")
...
data.site$study_id <- "Riccardo_Bommarco_Trifolium_pratense_Sweden_2009"
...
insect_sampling <- tibble(
  study_id = "Riccardo_Bommarco_Trifolium_pratense_Sweden_2009",
  ...
  total_sampled_area = 3.6*50*data_obs_guild$'N sites', # In 2009, each site was visited between three to five times (mean 3.6  visits per site)
  total_sampled_time = NA,
  total_sampled_flowers = NA,
  Description = "Bumble-bees were collected along 1 m wide and 50 m long transects in 14 sites. Each site was visited three to five times (mean 3.6  visits per site)."
)

setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(insect_sampling, "insect_sampling_Riccardo_Bommarco_Trifolium_pratense_Sweden_2009.csv")
setwd(dir_ini)
...
data_obs_guild_2 <-  data_obs_guild %>% filter(!is.na(Guild)) %>%
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Riccardo_Bommarco_Trifolium_pratense_Sweden_2009.csv")
setwd(dir_ini)
