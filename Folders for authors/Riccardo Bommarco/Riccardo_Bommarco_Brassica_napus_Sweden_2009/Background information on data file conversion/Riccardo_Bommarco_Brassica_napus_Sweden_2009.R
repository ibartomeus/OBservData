...
data_raw <- read_csv("Individual CSV/Bommarco_Rundlof_2009.csv")
...
write_csv(insect_sampling, "insect_sampling_Riccardo_Bommarco_Brassica_napus_Sweden_2009.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Riccardo_Bommarco_Brassica_napus_Sweden_2009.csv")
setwd(dir_ini)
