...
data.site <- read.xlsx("DATASETS/Stan01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/Stan01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Dara_Stanley_Brassica_napus_Ireland_2010.csv")
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Dara_Stanley_Brassica_napus_Ireland_2010.csv")
setwd(dir_ini)
