...
data_raw <- read.xlsx("46_47_RachaelWinfreeTomato_2004_2005/STEP4_winfree_tomato.xlsx",
                       sheet = "tomato0405")
...
write_csv(insect_sampling, "insect_sampling_Rachael_Winfree_Solanum_lycopersicum_USA_2005.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rachael_Winfree_Solanum_lycopersicum_USA_2005.csv")
setwd(dir_ini)
