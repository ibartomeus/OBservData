...
##########################
#Data: 48_RachaelWinfreeCranberry_2009
##########################

data_raw <- read.xlsx("48_49_RachaelWinfreeCranberry_2009_2010/STEP4_winfree_cranberry.xlsx",
                       sheet = "cranberry0910")
...
# Filter data by year
data_raw <- data_raw %>% filter(grepl("2009",data_raw$study_year,ignore.case = TRUE))
...
data.site$study_id <- "Rachael_Winfree_Vaccinium_macrocarpon_USA_2009"
...
list_organisms_guild$Guild[list_organisms_guild$Organism_ID=="Bombus_citrinus"] <- "bumblebees"
...
list_organisms_guild$Guild[list_organisms_guild$Organism_ID=="Bombus_sandersoni"] <- "bumblebees"
...
insect_sampling <- tibble(
  study_id = "Rachael_Winfree_Vaccinium_macrocarpon_USA_2009",
...
write_csv(insect_sampling, "insect_sampling_Rachael_Winfree_Vaccinium_macrocarpon_USA_2009.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Rachael_Winfree_Vaccinium_macrocarpon_USA_2009.csv")
setwd(dir_ini)
