...
data.site <- read.xlsx("DATASETS/ZouY01_Datacollection_pollination.xlsx",
...
data.Functioning <- read.xlsx("DATASETS/ZouY01_Datacollection_pollination.xlsx",
...
data.LandscapeData <- read.xlsx("DATASETS/ZouY01_Datacollection_pollination.xlsx",
...
write_csv(insect_sampling, "insect_sampling_Yi_Zou_Brassica_napus_China_2015.csv")
...
#########################################
#Solo hay pantraps <- No abundance
data.site$total <- NA
data.site$honeybees <- NA
data.site$bumblebees <- NA
data.site$other_wild_bees <- NA
data.site$syrphids <- NA
data.site$humbleflies <- NA
data.site$other_flies <- NA
data.site$beetles <- NA
data.site$lepidoptera <- NA
data.site$non_bee_hymenoptera <- NA
data.site$other <- NA
######################################################
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Yi_Zou_Brassica_napus_China_2015.csv")
setwd(dir_ini)
