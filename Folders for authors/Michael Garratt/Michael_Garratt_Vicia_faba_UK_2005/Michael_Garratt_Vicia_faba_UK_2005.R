...
data.site$study_id <- "Michael_Garratt_Vicia_faba_UK_2005"
...
insect_sampling <- tibble(
  study_id = "Michael_Garratt_Vicia_faba_UK_2005",
...
write_csv(insect_sampling, "insect_sampling_Michael_Garratt_Vicia_faba_UK_2005.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Michael_Garratt_Vicia_faba_UK_2005.csv")
setwd(dir_ini)
