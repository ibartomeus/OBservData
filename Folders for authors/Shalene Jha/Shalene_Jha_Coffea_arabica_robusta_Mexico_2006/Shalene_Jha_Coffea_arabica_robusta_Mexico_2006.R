...
data.site$study_id <- "Shalene_Jha_Coffea_arabica_robusta_Mexico_2006"
...
insect_sampling <- tibble(
  study_id = "Shalene_Jha_Coffea_arabica_robusta_Mexico_2006",
...
write_csv(insect_sampling, "insect_sampling_Shalene_Jha_Coffea_arabica_robusta_Mexico_2006.csv")
setwd(dir_ini)
...
setwd("C:/Users/USUARIO/Desktop/OBservData/Datasets_storage")
write_csv(field_level_data, "field_level_data_Shalene_Jha_Coffea_arabica_robusta_Mexico_2006.csv")
setwd(dir_ini)
