...
context("Verification that the values in field_level_data files with 68 variables meet our requirements")
...
labels_OK <- c("study_id","study_id2","site_id","crop","variety","management","country","latitude",
